 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaohashu_group_" + MQConstants.TOPIC_COLLECT_OR_UNCOLLECT, // Group 组
        topic = MQConstants.TOPIC_COLLECT_OR_UNCOLLECT, // 消费的主题 Topic
...
public class CollectUnCollectNoteConsumer implements RocketMQListener<Message> {
    ...
    public void onMessage(Message message) {
        ...
        } else if (Objects.equals(tags, MQConstants.TAG_UNCOLLECT)) { // 取消收藏笔记
