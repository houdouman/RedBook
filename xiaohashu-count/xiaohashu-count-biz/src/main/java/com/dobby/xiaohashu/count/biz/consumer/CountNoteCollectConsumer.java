...
import com.dobby.xiaohashu.count.biz.enums.CollectUncollectNoteTypeEnum;
import com.dobby.xiaohashu.count.biz.model.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.dobby.xiaohashu.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
        ...
        for (Map.Entry<Long, List<CountCollectUnCollectNoteMqDTO>> entry : groupMap.entrySet()) {
            ...
            for (CountCollectUnCollectNoteMqDTO countCollectUncollectNoteMqDTO : list) {
                ...
                switch (collectUncollectNoteTypeEnum) {
                    ...
                    case UNCOLLECT -> finalCount -= 1; // 如果为取消收藏操作，收藏数 -1
                }
            }
