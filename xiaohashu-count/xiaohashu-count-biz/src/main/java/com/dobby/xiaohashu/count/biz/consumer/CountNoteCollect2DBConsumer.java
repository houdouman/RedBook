...
import com.dobby.xiaohashu.count.biz.domain.mapper.NoteCountDOMapper;
import com.dobby.xiaohashu.count.biz.domain.mapper.UserCountDOMapper;
import com.dobby.xiaohashu.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaohashu_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT_2_DB,
